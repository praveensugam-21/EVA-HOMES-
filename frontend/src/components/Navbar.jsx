...
import { FaHome, FaUser, FaBars, FaTimes, FaBell, FaArrowLeft, FaArrowRight } from "react-icons/fa";
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between h-16 px-6">
        <div className="flex items-center gap-3">
          <button
            ...
            aria-label="Go back"
            title="Go back"
            className="w-8 h-8 shrink-0 rounded-lg flex items-center justify-center text-white/90 hover:text-steel-dark hover:bg-cream transition"
          >
